<template>
	<div
		...
		class="absolute bottom-3 left-3 size-16"
		@click="showCookieMessage = true"
	>
		<svg
		...
		>
			...
			<path
				fill="#dda85f"
				d="m50.1 10.8l-1.4 1.4l-1.3-1.4l1.3-1.3zm5.7 7l-.6.7l-.7-.7l.7-.7zm-5-4.6l-.7.7l-.7-.7l.7-.7zm-6.2-6.1l-.7.7l-.7-.7l.7-.7zm12.6 13.2l-.7.7l-.7-.7l.7-.7zm.6-2.5l-.7.7l-.7-.7l.7-.7z"
			/>
			<path
				fill="#6d4934"
			...
			<path
				fill="#a37f6a"
				d="M43.8 36.7c1.1-.3 2.8-3.7 1-3.9c-3.1-.5-5.5 1-5.2 2.7s3.4 1.4 4.2 1.2"
			/>
			<path
				fill="#6d4934"
			...
			<path
				fill="#dda85f"
				d="m14.706 33.483l1.979-1.98l1.98 1.979l-1.979 1.98zm19.992 11.328l1.98-1.98l1.98 1.98l-1.98 1.98zm-2.66-5.522l2.687-2.687l2.687 2.687l-2.687 2.687zM24.696 9.827l2.687-2.687l2.687 2.687l-2.687 2.687z"
			/>
			<path
				fill="#6d4934"
				d="m41.122 46.347l1.98-1.98l1.98 1.98l-1.98 1.98zm7.954-11.132l1.98-1.98l1.98 1.98l-1.98 1.98zm-7.264-10.578l.99-.99l.99.99l-.99.99zM13.726 38.266l.99-.99l.99.99l-.99.99z"
			/>
		</svg>
	</div>
	...
	<AppModal :show="showCookiePreferences">
		<div
			v-for="(_, cookie_type_index) in getCookieCategories"
			:key="cookie_type_index"
		>
			<div
				v-if="getCookiesForType(cookie_type_index).length > 0"
				class="mt-4"
			>
...
const showCookiePreferences = ref<boolean>(false)
const getCookieCategories = ref<string[]>([])
